...
class Person: 
    ...
    def __init__(self, first_name: str = "", last_name: str = ""):
        """
        This function intializes an instance of a class Person.
    ...
    def read_data_from_file(file_name: str, student_data: list):
        ...
        try:
            ...
            for student_dictionary in list_of_dictionary_data:
                new_student = Student(first_name = student_dictionary["FirstName"], last_name = student_dictionary["LastName"], course_name = student_dictionary["CourseName"])
